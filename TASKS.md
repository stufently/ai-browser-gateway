...
cf-fetch. Следующий шаг — короткая разведка Grok на принятом M9 и спека M10;
...
- [ ] **M10 и далее (границы уточняются разведкой):** продуктовая
  лестница со Scrapling; HTTP API с токеном, форматом
