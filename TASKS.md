...
- [ ] **M22 — публичный README под поиск и цитирование (решение владельца
  22.09.2026).** Объём — «страница репо + README»: GitHub Pages и внешние
  публикации не входят. Спека `docs/specs/m22-repo-seo.md`, чекеры
  `docs/specs/checks/m22_readme_seo.py` (состав разделов, FAQ, таблица
  сравнения, рабочие ссылки) и `docs/specs/checks/m22_no_new_domains.py`
  (новых доменов, IP и путей `/home/...` в отслеживаемых файлах быть не
  должно — директива владельца о списке сайтов). Исполнитель — Grok: у Codex
  22.09 кончился лимит аккаунта до 24.09. Настройки самой страницы репозитория
  (темы, homepage, карточка) делает координатор руками отдельно.
