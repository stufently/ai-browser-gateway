...
- [ ] **M16 — IN_PROGRESS 18.09.2026: ложная `captcha` на честном HTTP 200.**
  ...
  - M16a-fix5 (черновик) — только тесты: восемь дыр, шесть из независимого
    прогона Grok по fix2 и две по fix3 (завершающая `;` у клипованной ссылки и
    два гигантских рефа в одном теле), все covered-but-not-asserted.
