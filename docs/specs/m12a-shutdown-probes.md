...
**Директива владельца 17.09.2026** снимает остановку 15.09: оставшиеся задачи
M12 доделываются через cx. Исправление M12a напишет ДРУГАЯ cx-панель в другом
клоне; этот пакет не видит её контекста, она не видит эталонов отсюда. Клон
пересоздан 17.09 на том же BASE. Ниже «Координатор соберёт единый возврат
Grok» читать как «возврат исполнителю исправления».
