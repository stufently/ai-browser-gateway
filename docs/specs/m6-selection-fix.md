...
- **AC-623 — зонд постановщика проходит; сам зонд не подменён.**
  `bash -c 'cd /home/user/exec-clones/abg-m6-selection && echo "3cce266b96bcca232d9abf2df4b37831e1696399f695cba7c27e1b28045acbb8  probes/m6_fix_probe.py" | sha256sum -c - && python3 probes/m6_fix_probe.py'`
