# M12b — независимые мутации тестов deployed-runner
...
Клон /home/user/exec-clones/abg-m12b-runner-mutations-20260917, ветка
m12b-runner-mutations, origin push DISABLED. SOURCE_SHA
`25dfa5c` (полный SHA — `git rev-parse HEAD` в клоне; FINAL M12b).
Выход: /home/user/.cache/abg-coord-20260917/m12b-mutations/.
...
Прочитать целиком его и `docs/specs/m12b-deploy.md`.
...
20–28 смысловых мутантов по одному изменению, каждый в отдельной копии дерева
